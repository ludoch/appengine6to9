...
public class VmApiProxyEnvironment implements ApiProxy.Environment {
  ...
  // TODO(isdal): remove old metadata attributes once we set environment variables everywhere.
  ...
  // TODO(ttrimble): Change the name to MODULE_ATTRIBUTE, as the field contains the name of the
  // App Engine Module.
  ...
  public static VmApiProxyEnvironment createDefaultContext(Map<String, String> envMap,
    ...
    attributes.put(
        BACKGROUND_THREAD_FACTORY_ATTR, new VmBackgroundThreadFactory(defaultEnvironment));
  ...
  protected final Timer wallTimer;  // may be null if millisUntilSoftDeadline is null.
  protected final Long millisUntilSoftDeadline;  // may be null (no deadline).
   ...
   */
  protected VmApiProxyEnvironment(
    ...
    // TODO(isdal): forward app_log_line_size, app_log_group_size, max_log_flush_seconds
